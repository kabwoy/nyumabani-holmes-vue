...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <router-link to="/"  class="flex items-center">
      <!-- <img src="../assets/house.svg" class="h-8 mr-3" alt="Flowbite Logo"> -->
      <!-- <span class="h-8 mr-3">🏘</span> -->
      <span class="self-center md:text-2xl font-semibold whitespace-nowrap dark:text-white text-blue-700 sm:text-1xl">🏘Nyumbani Holmes</span>
  </router-link>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <router-link :to="{name:'home'}" class="block py-2 pl-3 pr-4 text-dark  rounded   md:p-0 md:dark:text-blue-500" aria-current="page">Home</router-link>
      </li>
      <li>
      ...
      <li>
        <router-link to="/houses" href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Houses</router-link>
      </li>
      <li>
